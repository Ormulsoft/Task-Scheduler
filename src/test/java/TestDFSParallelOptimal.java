...
public class TestDFSParallelOptimal {
	...
	public void node7Proc2Core1() {
		...
		ScheduleGrph out = new DFSParallel(_7In, new AStarCostFunction(_7In), 2, 1).runAlg();
	...
	public void node8Proc2Core1() {
		...
		ScheduleGrph out = new DFSParallel(_8In, new AStarCostFunction(_8In), 2, 1).runAlg();
	...
	public void node9Proc2Core1() {
		...
		ScheduleGrph out = new DFSParallel(_9In, new AStarCostFunction(_9In), 2, 1).runAlg();
	...
	public void node10Proc2Core1() {
		...
		ScheduleGrph out = new DFSParallel(_10In, new AStarCostFunction(_10In), 2, 1).runAlg();
	...
	public void node11Proc2Core1() {
		...
		ScheduleGrph out = new DFSParallel(_11In, new AStarCostFunction(_11In), 2, 1).runAlg();
	...
	public void node7Proc4Core1() {
		...
		ScheduleGrph out = new DFSParallel(_7In, new AStarCostFunction(_7In), 4, 1).runAlg();
	...
	public void node8Proc4Core1() {
		...
		ScheduleGrph out = new DFSParallel(_8In, new AStarCostFunction(_8In), 4, 1).runAlg();
		assertEquals(581, getEndTime(out));
	}
	...
	public void node9Proc4Core1() {
		...
		ScheduleGrph out = new DFSParallel(_9In, new AStarCostFunction(_9In), 4, 1).runAlg();
		assertEquals(55, getEndTime(out));
	}
	...
	public void node10Proc4Core1() {
		...
		ScheduleGrph out = new DFSParallel(_10In, new AStarCostFunction(_10In), 4, 1).runAlg();
		assertEquals(50, getEndTime(out));
	}
	...
	public void node11Proc4Core1() {
		...
		ScheduleGrph out = new DFSParallel(_11In, new AStarCostFunction(_11In), 4, 1).runAlg();
