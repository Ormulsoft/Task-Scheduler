...
public class PartialScheduleGrph extends ScheduleGrph {
	...
	/**
	 * A graphing class for an intermediary partial schedule generated during algorithm runs.
	 * Used to represent a potential partial solution for the problem on the tree.
	 */
